<html>
    ...
    <body>
        ...
        <p class="sequence"><strong>Número de RELACIÓN DE SERVICIOS DE TPS:</strong> {{ $collectionAccount->id }}</p>
        <table id="payment-info">
            <tr>
                <th>Fecha de RELACIÓN DE SERVICIOS DE TPS:</th>
                <td>{{ $now }}</td>
                <th>Período de RELACIÓN DE SERVICIOS DE TPS:</th>
